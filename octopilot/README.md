...
| `op_version` | No | `v1.0.13` | Version of the `ghcr.io/octopilot/op` container image to use in non-bypass mode. Use v1.0.13+ for chart artifacts (Docker API, no run image). |
